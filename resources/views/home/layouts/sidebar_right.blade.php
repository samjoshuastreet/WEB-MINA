<div id="right-sidebar" class="absolute h-full w-[30%] bg-upsdell-900 top-0 right-[-30%] z-50 p-3" style="overflow-y: auto; -ms-overflow-style: none; scrollbar-width: none;">
    ...
    <button id="directions-end-btn" class="font-poppins-regular absolute bottom-0 left-[50%] translate-x-[-50%] text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">End</button>
</div>