<div id="popup-sample" class="absolute top-[7.5%] right-[-100%] translate-x-[-7.5%] translate-y-[7.5%] bg-upsdell-900 z-20 lg:h-[75%] lg:w-[75%] flex items-center justify-center rounded-lg transition duration-500">
    <div class="w-[97.5%] h-[95%] bg-white rounded-lg">
        ...
        <h1 id="popup-building-name" class="font-upsdell-900 font-poppins-regular text-3xl text-center p-6">Sample Popup</h1>
        <div class="w-[100%] bg-transparent flex justify-center items-center">
            <div class="w-[85%] shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-lg flex">
                <figure class="max-w-lg w-[40%] p-4">
                    <img id="popup-image" class="w-full h-auto max-w-full rounded-lg" src="" alt="">
                </figure>
...
<div id="popup-procedure" class="absolute top-[7.5%] right-[-100%] translate-x-[-7.5%] translate-y-[7.5%] bg-upsdell-900 z-20 lg:h-[75%] lg:w-[75%] flex items-center justify-center rounded-lg transition duration-500">
...
<div id="popup-event" class="absolute top-[7.5%] right-[-100%] translate-x-[-7.5%] translate-y-[7.5%] bg-upsdell-900 z-20 lg:h-[75%] lg:w-[75%] flex items-center justify-center rounded-lg transition duration-500">
    <div class="w-[97.5%] h-[95%] bg-white rounded-lg">
